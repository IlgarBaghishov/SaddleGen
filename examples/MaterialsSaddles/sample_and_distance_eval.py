...
def run_one_case(record: dict, loss_module: FlowMatchingLoss, *, K: int,
    ...
    pred = sample_saddles(
        ...
        eigenmode_head=loss_module.eigenmode_head,   # v7-3: drives F_dimer
        frozen_force_backbone=loss_module.frozen_force_backbone,    # v7-4-redesign
        dimer_residual_alpha=(
            loss_module.dimer_residual_alpha if loss_module.use_dimer_residual else None
        ),
    )  # (1, N, 3)
